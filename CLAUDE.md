...
**YOU ARE IN: `pace/polecats/thunder/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/pace/` (rig root) or other directories
...
**Your mail address:** `pace/polecats/thunder`
**Your rig:** pace
**Your Witness:** `pace/witness`
...
| Ask Witness for help | `gt mail send pace/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`pace/witness`) when:
...
```bash
gt mail send pace/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
